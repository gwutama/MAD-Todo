...
public class DbConsts {
  ...
  /** The Constant SORT_IMPORTANCE_DATE represents the todo list sorting by importance+date.
   * This is the "WHERE" clause of the SQL query. */
  public static final String SORT_IMPORTANCE_DATE =
      Column.IS_MARKED_DONE + ", " + Column.IS_IMPORTANT + " DESC , " + Column.EXPIRY;
  
  /** The Constant SORT_DATE_IMPORTANCE represents the todo list sorting by date+importance.
   * This is the "WHERE" clause of the SQL query. */
